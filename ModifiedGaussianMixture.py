...
def _check_precisions(precisions, covariance_type, n_components, n_features):
    ...
    precisions_shape = {
        ...
        "tied_full": (n_features, n_features),
    ...
    _check_precisions = {
        ...
        "tied_full": _check_precision_matrix,
...
def _estimate_gaussian_covariances_tied_diag(resp, X, nk, means, reg_covar):
    ...
    tied_cov = _estimate_gaussian_covariances_tied_full(resp, X, nk, means, reg_covar)
    tied_diag_covariance = np.diag(tied_cov)
    k = len(_estimate_gaussian_covariances_diag(resp, X, nk, means, reg_covar))
    return np.vstack([tied_diag_covariance] * k)


def _estimate_gaussian_covariances_tied_spherical(resp, X, nk, means, reg_covar):
    variances = _estimate_gaussian_covariances_diag(resp, X, nk, means, reg_covar).mean(1)
    tied_spherical_variance = variances.mean()
    return tied_spherical_variance
...
def _estimate_gaussian_parameters(X, resp, reg_covar, covariance_type):
    ...
    covariance_type : {'full', 'tied', 'diag', 'spherical', 'tied_spherical', 'tied_diag'}
    ...
    covariances = {
        ...
        "tied_full": _estimate_gaussian_covariances_tied_full,
...
def _estimate_log_gaussian_prob(X, means, precisions_chol, covariance_type):
    ...
    if covariance_type == "full":
    ...
    elif "spherical" in covariance_type:
        precisions = precisions_chol**2
        log_prob = (
        ...
        raise ValueError(
            "Invalid covariance_type. Supported values are 'full', 'tied', 'diag', 'spherical', 'tied_spherical', and 'tied_diag'.")
...
class GaussianMixture(BaseMixture):
    ...
    covariance_type : {'full', 'tied', 'diag', 'spherical', 'tied_spherical', 'tied_diag'}, default='full'
    ...
    _parameter_constraints: dict = {
        **BaseMixture._parameter_constraints,
        "covariance_type": [StrOptions({"full", "tied_full", "diag", "spherical", "tied_spherical", "tied_diag"})],
    ...
    def _n_parameters(self):
        ...
        elif "diag" in self.covariance_type:
